...
export default function ProductDetailClient({ product, initialRelated = [] }) {
  ...
  useEffect(() => {
    if (product) {
      ...
      // If initialRelated is empty, fetch related products client-side as fallback
            ...
            >
              ...
              <div className="grid grid-cols-3 gap-4 mb-8">
                ...
                <div className="text-center p-4 bg-white rounded-xl">
                  ...
                  <div className="text-sm font-semibold text-burhan-primary">{product.warranty || 'Official Warranty'}</div>
                </div>
                <div className="text-center p-4 bg-white rounded-xl">
